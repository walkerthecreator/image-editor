const fileInput = document.querySelector('.file-input'),
    ...
    shapesBtn = document.querySelector('shapes-btn')
...
shapesBtn.addEventListener('click' , function () { 
    var circle = new fabric.Circle({
        ...
        radius: 50,
        fill: 'red',
        hasControls: true, // Enables resizing controls
        hasBorders: true,  // Enables border controls
        selectable: true   // Allows the circle to be selected
    });
